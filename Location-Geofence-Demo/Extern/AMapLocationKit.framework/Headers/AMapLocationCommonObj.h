...
@property (nonatomic, strong) AMapLocationPoint *location;     //!< 经纬度
...
@property (nonatomic, copy) NSString *cityCode;                     //!< 城市编码
@property (nonatomic, copy) NSString *districtCode;                 //!< 区域编码
@property (nonatomic, copy) NSString *district;                     //!< 区名
@property (nonatomic, copy) NSArray <NSArray<AMapLocationPoint *> *> *polylinePoints; //!< 行政区域轮廓坐标点，每个行政区可能有多个模块,每个模块的坐标点数组由AMapLocationPoint构成
